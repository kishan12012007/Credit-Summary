...
public class DBhandler extends SQLiteOpenHelper {
    ...
    private static final String DATE = "duration";

    // below variable for our course description column.
    private static final String CASH = "description";

    // below variable is for our course tracks column.
    private static final String CATEGORY = "tracks";

    // creating a constructorcour for our database handler.
    ...
    public void addNewCourse(String courseName, String date, String cash, String category) {
    ...
    public void updateCourse(String originalCourseName, String courseName, String courseDescription,
        ...
        // along with its key and value pair.
        values.put(NAME_COL, courseName);
        values.put(DATE, courseDuration);
        values.put(CASH, courseDescription);
